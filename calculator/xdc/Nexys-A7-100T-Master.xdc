...
create_clock -period 200.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports CLK100MHZ]
...
set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports {out[7]}]
